...
class m140703_123000_user extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%user}}', [
            ...
            'activation_key'       => Schema::TYPE_STRING . '(32) NOT NULL',
            'password_hash'        => Schema::TYPE_STRING . ' NOT NULL',
            'password_reset_token' => Schema::TYPE_STRING,
            'oauth_client'         => Schema::TYPE_STRING,
            'oauth_client_user_id' => Schema::TYPE_STRING,
            'email'                => Schema::TYPE_STRING . ' NOT NULL',
            'role'                 => Schema::TYPE_STRING . '(32) NOT NULL DEFAULT "' . \common\models\User::ROLE_USER.'"',
        ...
        $this->insert('{{%user}}', [
            ...
            'activation_key'=> Yii::$app->getSecurity()->generateRandomString(),
